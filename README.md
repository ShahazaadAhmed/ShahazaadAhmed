...
Building practical security tools for **networks, systems, and defensive automation**.

<br>

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square\&logo=linkedin\&logoColor=white)](https://www.linkedin.com/in/shahazaad-ahmed-b84147227/)
[![Portfolio](https://img.shields.io/badge/Portfolio-111827?style=flat-square\&logo=vercel\&logoColor=white)](https://shahazaadahmed.vercel.app/)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square\&logo=github\&logoColor=white)](https://github.com/ShahazaadAhmed)
...
I'm a **Cybersecurity developer focused on Python, network security, and security automation**.

I build hands-on projects around network reconnaissance, firewall management, cryptography, and security tooling, while also exploring applied AI/ML and computer vision.

My approach is simple:

> **Understand the security problem → engineer the solution → make it usable.**

* 🔐 Network & systems security
* 🐍 Python security tooling
* 🛡️ Firewall and defensive automation
* 🌐 Network reconnaissance and analysis
* 🔑 Cryptography and secure application design
...
![Scapy](https://img.shields.io/badge/Scapy-00BFFF?style=flat-square\&logo=python\&logoColor=white)
![nftables](https://img.shields.io/badge/nftables-FF6B35?style=flat-square\&logo=linux\&logoColor=white)
![Linux](https://img.shields.io/badge/Linux-FCC624?style=flat-square\&logo=linux\&logoColor=black)
![PyCryptodome](https://img.shields.io/badge/PyCryptodome-8B0000?style=flat-square\&logo=python\&logoColor=white)
...
![CustomTkinter](https://img.shields.io/badge/CustomTkinter-1c1c2e?style=flat-square\&logo=python\&logoColor=white)
...
### 🛡️ Firewall Policy Engine

A GUI-based firewall policy management tool designed around safer ruleset deployment.
...
**Stack:** `Python` · `nftables` · `SQLite` · `CustomTkinter`

[View Repository →](https://github.com/ShahazaadAhmed/Firewall-Policy-Engine-FPE-)
